...
export default function PublicTagPage() {
  ...
  const handleParkingAlert = async () => {
    ...
    try {
      await api.post(\`/public/tag/\${tagCode}/alert\`, { scannerPhone: "Parking Alert" });
  ...
  if (loading) {
     return (
       <div className="min-h-screen bg-[#061B44] flex flex-col items-center justify-center p-6">
         <div className="size-12 border-4 border-[#F5B700] border-t-transparent rounded-full animate-spin mb-4" />
  ...
  if (!tag) {
    return (
      <div className="min-h-screen bg-[#061B44] flex flex-col items-center justify-center p-8 text-center">
        ...
        <button onClick={() => window.location.href = 'https://tarkshyasolution.in'} className="bg-[#F97316] text-white px-8 py-3 rounded-xl font-bold uppercase tracking-widest text-xs shadow-lg">
          {t.returnHome}
        </button>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans relative flex flex-col items-center selection:bg-[#F5B700]/30">
      
      {/* Hero Section */}
      <div className="w-full max-w-lg h-[320px] bg-[#061B44] rounded-b-[24px] relative z-10 flex flex-col items-center pt-6 px-4 overflow-hidden">
        ...
        <div className="w-full relative z-20 flex flex-col items-center text-center">
          ...
          <div className="w-full flex justify-between items-start mb-2">
            <div className="flex flex-col items-start">
               <div className="flex items-center gap-1.5 border border-[#16A34A]/50 bg-[#04122E] text-[#16A34A] px-2 py-1 rounded-md shadow-sm">
                 <ShieldCheck size={16} className="fill-[#16A34A]/20" />
            ...
            <div className="flex h-8 items-center justify-center rounded-full bg-white/10 p-1 shadow-sm border border-white/10">
              <label className="flex cursor-pointer h-full items-center justify-center rounded-full px-3 has-[:checked]:bg-white has-[:checked]:text-[#061B44] text-white/70 text-[10px] font-bold transition-all uppercase">
                <span>HI</span>
          ...
          <h2 className="text-[12px] font-[700] text-[#F5B700] tracking-[0.4em] mb-4">SECURITY</h2>
          
          <p className="text-white/90 text-[15px] font-[600] mb-1">{t.subtitle}</p>
          <p className="text-white/60 text-[11px] mb-3">{t.features}</p>
          
          <div className="bg-[#04122E]/80 border border-white/10 px-4 py-1.5 rounded-full text-white/90 font-mono text-[11px] tracking-widest shadow-inner mb-3">
            {t.assetId}: {tag.tagCode}
          </div>
      ...
      <div className="w-full max-w-lg px-[16px] relative z-20 flex flex-col gap-[12px] pb-[20px] -mt-[32px]">
        ...
        <div className="bg-white rounded-[20px] p-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.05)] flex items-center justify-between">
          <div className="flex items-center gap-4">
             <div className="relative">
               ...
               <div className="absolute -bottom-1 -right-1 size-[22px] bg-[#16A34A] border-2 border-white rounded-full flex items-center justify-center">
                 <CheckCircle2 size={12} className="text-white" />
               </div>
             </div>
             <div className="flex flex-col">
               <h3 className="text-[#061B44] font-[700] text-[18px] leading-tight uppercase">{tag.ownerName}</h3>
               <div className="flex items-center gap-1.5 mt-1">
                 <CheckCircle2 size={12} className="text-[#16A34A]" />
                 <span className="text-[12px] text-[#16A34A] font-[600]">{t.verifiedOwner}</span>
               </div>
               <div className="flex items-center gap-1.5 mt-0.5">
                 <ShieldCheck size={12} className="text-slate-500" />
                 <span className="text-[12px] text-slate-500 font-medium">{t.vehicleProtected}</span>
               </div>
             </div>
          </div>
          <div className="flex flex-col items-center">
             <div className="bg-blue-50 p-2 rounded-full border border-blue-100 mb-1">
               <Shield className="size-[24px] text-[#2563EB] fill-[#2563EB]/20" />
             </div>
             <span className="text-[9px] font-[700] text-[#061B44] text-center leading-[1.1] uppercase w-12">{t.verifiedOwner}</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-[12px]">
          ...
          <button 
            ...
            className="w-full h-[80px] bg-[#16A34A] hover:bg-[#15803D] text-white rounded-[18px] px-4 flex items-center justify-between transition-colors shadow-sm"
          >
             <div className="flex items-center gap-4">
               <div className="bg-white size-[52px] rounded-full flex items-center justify-center shadow-sm">
                 <Phone size={26} className="fill-[#16A34A] text-[#16A34A]" />
               </div>
          ...
          <button 
            ...
            className="w-full h-[72px] bg-[#16A34A]/95 hover:bg-[#15803D]/95 text-white rounded-[18px] px-4 flex items-center justify-between transition-colors shadow-sm"
          >
             <div className="flex items-center gap-4">
               <div className="bg-white size-[44px] rounded-full flex items-center justify-center shadow-sm">
                 <MessageCircle size={26} className="text-[#16A34A] fill-[#16A34A]" />
               </div>
               <div className="flex flex-col items-start text-left">
             ...
             <div className="flex items-center gap-2">
               <span className="bg-[#F5B700] text-[#061B44] text-[9px] font-[700] px-2 py-1 rounded-[6px] flex items-center gap-1 shadow-sm uppercase">
                 <Shield size={10} className="fill-[#061B44]" /> {t.premium}
               </span>
               <ChevronDown size={24} className="text-white/70 -rotate-90" />
             </div>
          </button>
          ...
          <button 
            ...
            className="w-full h-[72px] bg-[#F97316] hover:bg-[#EA580C] text-white rounded-[18px] px-4 flex items-center justify-between transition-colors shadow-sm"
          >
             <div className="flex items-center gap-4">
               <div className="bg-white/20 size-[44px] rounded-full flex items-center justify-center">
                 <ParkingCircle size={26} className="fill-white text-[#F97316]" />
               </div>
               <div className="flex flex-col items-start text-left">
        ...
        <div className="bg-white rounded-[16px] border border-[#E2E8F0] overflow-hidden mt-[8px]">
           ...
           >
             <div className="flex items-center gap-2">
               <ShieldCheck size={20} className="text-[#DC2626] fill-[#DC2626]/20" />
               <h4 className="font-[700] text-[#061B44] text-[15px]">{t.emergencyOptions}</h4>
             </div>
             <div className="flex items-center gap-2">
           ...
           {emergencyExpanded && (
             <div className="px-4 pb-4 border-t border-[#E2E8F0] pt-4 animate-in fade-in slide-in-from-top-2 duration-200">
               ...
               <div className="grid grid-cols-2 gap-[12px] mb-[12px]">
                  <button onClick={handleSOS} className="bg-red-50/50 border border-red-100 rounded-[12px] p-3 flex flex-col justify-center hover:bg-red-50 transition-colors relative min-h-[76px]">
                    <div className="flex items-start gap-2 w-full text-left">
                      <Siren size={24} className="text-[#DC2626] fill-[#DC2626] shrink-0" />
                      <div className="flex flex-col flex-1 pr-4">
                        <span className="font-[700] text-[11px] text-[#DC2626] leading-tight">{t.sosEmergency}</span>
                        <span className="text-[10px] text-slate-500 mt-1 leading-tight">{t.immediateHelp}</span>
                      </div>
                    </div>
                    <ChevronDown size={14} className="text-[#DC2626] -rotate-90 absolute right-3 top-1/2 -translate-y-1/2" />
                  </button>
                  ...
                  <button className="bg-blue-50/50 border border-blue-100 rounded-[12px] p-3 flex flex-col justify-center hover:bg-blue-50 transition-colors relative min-h-[76px]">
                    <div className="flex items-start gap-2 w-full text-left">
                      <MapPin size={24} className="text-[#2563EB] fill-[#2563EB] shrink-0" />
                      <div className="flex flex-col flex-1 pr-4 pb-4">
                        <span className="font-[700] text-[11px] text-[#2563EB] leading-tight">{t.shareLocation}</span>
                        <span className="text-[9px] text-slate-500 mt-1 leading-tight">{t.shareLocationSub}</span>
                      </div>
                    </div>
                    <ChevronDown size={14} className="text-[#2563EB] -rotate-90 absolute right-3 top-1/2 -translate-y-1/2" />
                    <div className="absolute bottom-2 left-[38px]">
                      <span className="bg-[#F5B700] text-[#061B44] text-[8px] font-[700] px-1.5 py-0.5 rounded-[4px] flex items-center gap-0.5 uppercase">
                        <Shield size={8} className="fill-[#061B44]" /> {t.premium}
                      </span>
                    </div>
                  </button>
               </div>
                  ...
                  <a href="tel:112" className="bg-white border border-slate-200 rounded-[12px] p-3 flex items-center justify-between hover:bg-slate-50 transition-colors no-underline min-h-[64px]">
                    <div className="flex items-center gap-3 text-left">
                      <div className="size-[36px] bg-blue-100 rounded-lg flex items-center justify-center shrink-0">
                         <ShieldCheck size={20} className="text-[#061B44] fill-[#061B44]/20" />
                      </div>
                      <div className="flex flex-col">
                        <span className="font-[700] text-[11px] text-[#2563EB]">{t.police}</span>
                        <span className="text-[10px] text-slate-500 leading-tight">{t.callPolice}</span>
                        <span className="font-[900] text-[13px] text-[#061B44] leading-tight mt-0.5">112</span>
                      </div>
                    </div>
                  ...
                  <a href="tel:108" className="bg-white border border-slate-200 rounded-[12px] p-3 flex items-center justify-between hover:bg-slate-50 transition-colors no-underline min-h-[64px]">
                    <div className="flex items-center gap-3 text-left">
                      <div className="size-[36px] bg-red-100 rounded-lg flex items-center justify-center shrink-0">
                         <AlertTriangle size={20} className="text-[#DC2626] fill-[#DC2626]/20" />
                      </div>
                      <div className="flex flex-col">
                        <span className="font-[700] text-[11px] text-[#2563EB]">{t.ambulance}</span>
                        <span className="text-[10px] text-slate-500 leading-tight">{t.callAmbulance}</span>
                        <span className="font-[900] text-[13px] text-[#061B44] leading-tight mt-0.5">108</span>
                      </div>
                    </div>
                    <ChevronDown size={14} className="text-slate-400 -rotate-90" />
                  </a>
               ...
               <div className="bg-purple-50 border border-purple-100 rounded-[12px] p-3 flex items-center justify-between min-h-[56px]">
                  ...
                  <span className="bg-[#061B44] text-white text-[9px] font-[700] px-2 py-1.5 rounded-[6px] flex items-center gap-1 shadow-sm uppercase shrink-0">
        ...
        <div className="bg-white rounded-[20px] shadow-sm p-[20px] relative overflow-hidden mt-[8px] border border-slate-100">
           <div className="flex items-center gap-2 mb-4 relative z-10">
             <Car size={18} className="text-[#061B44]" />
             <h4 className="font-[700] text-[#061B44] text-[15px]">{t.vehicleDetails}</h4>
           </div>
           
           <div className="grid grid-cols-3 gap-y-[16px] gap-x-2 relative z-10">
              <div>
                 <p className="text-[11px] text-slate-500 mb-1">{t.vehicleType}</p>
                 <p className="text-[13px] font-[700] text-[#061B44]">{tag.assetType || 'N/A'}</p>
              </div>
              <div className="col-span-2">
                 <p className="text-[11px] text-slate-500 mb-1">{t.regNo}</p>
                 <p className="text-[14px] font-[700] text-[#061B44] tracking-widest">{maskNumber(tag.assetNumber || tag.tagCode)}</p>
              </div>
              <div>
                 <p className="text-[11px] text-slate-500 mb-1">{t.model}</p>
                 <p className="text-[13px] font-[700] text-[#061B44]">{tag.assetModel || 'N/A'}</p>
              </div>
              <div>
                 <p className="text-[11px] text-slate-500 mb-1">{t.color}</p>
                 <p className="text-[13px] font-[700] text-[#061B44]">{tag.assetColor || 'N/A'}</p>
              </div>
              <div>
                 <p className="text-[11px] text-slate-500 mb-1">{t.regState}</p>
                 <p className="text-[13px] font-[700] text-[#061B44]">N/A</p>
              </div>
              <div>
        ...
        <div className="bg-[#ECFDF5] rounded-[16px] p-4 flex items-start gap-3 mt-[8px] border border-[#A7F3D0]/50">
           <Lock size={20} className="text-[#16A34A] mt-0.5 shrink-0" />
           ...
           <a href="#" className="text-[11px] text-[#2563EB] font-[600] hover:underline mt-0.5 shrink-0">{t.learnMore}</a>
        </div>

        {/* Brand Footer Features */}
        <div className="h-[100px] bg-[#061B44] rounded-[24px] mt-[12px] px-2 flex flex-col justify-center">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#061B44]/80 backdrop-blur-sm p-4">
           <div className="bg-white rounded-3xl w-full max-w-sm p-6 shadow-2xl relative animate-in fade-in zoom-in duration-200">
             <div className="flex flex-col items-center text-center mb-6">
                <div className="size-14 rounded-full flex items-center justify-center mb-3 bg-[#16A34A]/10 text-[#16A34A]">
                  {modalAction === 'call' ? <Phone size={28} className="fill-[#16A34A]" /> : <MessageCircle size={28} className="fill-[#16A34A]" />}
                </div>
                <h3 className="text-[18px] font-[900] text-[#061B44] uppercase">{t.verifyIdentity}</h3>
             ...
             <form onSubmit={handleModalSubmit}>
                <div className="relative mb-6">
                  <input 
                    ...
                    className="w-full bg-slate-50 border-2 border-slate-200 rounded-[16px] py-4 px-4 text-center font-[700] text-[#061B44] focus:outline-none focus:border-[#061B44] transition-colors text-[18px] tracking-widest"
                    value={scannerPhone}
                ...
                <div className="flex gap-3">
                  ...
                  <button type="submit" disabled={actionLoading} className="flex-[2] py-4 bg-[#061B44] hover:bg-[#04122E] text-white rounded-[14px] font-[700] text-[12px] uppercase transition-colors flex items-center justify-center gap-2 shadow-lg">
...
fs.writeFileSync(path.join(__dirname, 'src/app/tag/[tagCode]/page.tsx'), fileContent);
