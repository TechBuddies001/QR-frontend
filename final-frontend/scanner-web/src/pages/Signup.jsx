...
import { Shield, Mail, Lock, UserPlus, Car, Bell, Cloud, User } from 'lucide-react';
    ...
    <AuthPage>
      ...
      <RightPanel>
        <AuthCard>
          ...
          <p className="desc">Join the ecosystem to manage your smart assets.</p>
          ...
          <div style={{ textAlign: 'center', marginTop: '35px', fontSize: '0.95rem', color: '#666' }}>
            Already have an account? <Link to="/login" style={{ color: '#0b1a33', fontWeight: 800, textDecoration: 'none' }}>Login Here</Link>
          </div>
        </AuthCard>
      </RightPanel>
    </AuthPage>
